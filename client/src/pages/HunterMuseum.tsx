            ...
            {crystals.map((crystal) => {
              ...
              return (
                <div key={crystal._id} className="relative group">
                  ...
                  <div className="flex flex-col md:flex-row gap-6 bg-black/60 border border-yellow-900/30 rounded-xl p-6 backdrop-blur-md transition-all duration-300 hover:border-yellow-700 hover:shadow-[0_0_30px_rgba(234,179,8,0.15)] relative overflow-hidden">
                    ...
                    <div className="relative z-10 flex-1 space-y-4">
                      <div>
                        <div className="flex items-center gap-3">
                          <h3 className="font-display font-bold text-xl uppercase tracking-widest text-yellow-400 drop-shadow-[0_0_10px_rgba(234,179,8,0.5)]">
                            {crystal.title}
                          </h3>
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-4 border-t border-gray-800/50">
